...
CREATE INDEX IF NOT EXISTS layers_map_position ON layers(owner_id, map_id, position);
CREATE INDEX IF NOT EXISTS features_layer_created ON features(owner_id, map_id, layer_id, created_at);
